            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                 ...
                                 <section style="background-image: url(img/worldbg.JPG); background-size: cover; padding: 20px;">



                                    <div class="container contains" id="con">   
                                        ...
                                        <h1 class="stud" style="color:#ffffff; text-align: center; ">Contact Us</h1>
            ...
            <div class="footer-content">
                <div class="container">
                    <div class="row">
                        ...
                        <!--<div class="col-lg-12 sprocess">-->
                        <!--    <div class="text-center social-icons social-icons-rounded social-icons-colored-hover social-icons-colored">-->
                        <!--        <ul>-->
