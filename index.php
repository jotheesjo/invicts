    ...
    <div class="container" style="padding: 0px 30px;">
        ...
        <div class="row">
            <div class="col-lg-4 text-center" data-animate="fadeInUp" data-animate-delay="0">
                <a href="service.php">
                    <img src="img/gif/Educational_Videos.gif " style=" width: 96%;">
                    <h3 class="edu">
                        Educational Videos
                    </h3>
                </a>
            ...
            <div class="col-lg-4 text-center" data-animate="fadeInUp" data-animate-delay="0">
                <a href="service.php">
                    <img src="img/gif/Explainer_Videos.gif" style=" width: 105%;">
                    <h3 class="edu" style="text-align: center;font-weight: 300;margin-top: -35px;font-size: 2em;">
                        Explainer Videos
                    </h3>
                </a>
            </div>
            ...
            <div class="col-lg-4 text-center" data-animate="fadeInUp" data-animate-delay="0">
                <a href="service.php">
                    <img src="img/gif/Product_Demo_Videos.gif" style=" width: 96%;">
                    <h3 class="edu">
                        Product Demo Videos
                    </h3>
                </a>
...
<!-- <section style="padding: 0px;">
    <img src="img/gif/whygig.gif" width="100%" style="background-size: 100% 100%;">
    <div class="centered col-lg-12">
        <h1 class="studs" style=" ">Why Invict Studios?</h1>
        <h3 style="color:#ffffff; text-align: center; font-weight: 100; ">In this competitive market, Invicts has more features<br>that will want you to choose us over others.</h3>
    </div>
</section> -->
    ...
    <section style="padding: 0px;">
        <div class="">
            ...
            <h1 class="mb-4"> Why Invict Studios?</h1>
            <h2 style="color:#ffffff; text-align: center; font-weight: 100; line-height: 1.3em;">In this competitive market, Invicts has more features<br> that will want you to choose us over others.</h2>
            </div>
            </div>
            </div>
            </div>
