...
include("aside.php");
if(isset($_GET['id'])){
$app_list=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM process WHERE process_id='$_GET[id]'"));
}
?>
                    ...
                    <div class="card-body">
                        ...
                        echo '<br/><p style="color:#ff0000">'.$_GET['msg'].'</p>';
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="process_id" required value="<?=$app_list['process_id'];?>">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-success" name="update_process"> <i class="fa fa-check"></i> Save</button>
                            </div>
                        </form>
                    </div>
                </div>
