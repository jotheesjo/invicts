<aside class="left-sidebar">
    <div class="d-flex no-block nav-text-box align-items-center">
        <span><img src="assets/images/slogo.png" alt=""></span>
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
            <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-account-network"></i><span class="hide-menu">Home</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="home-section1.php">Section 1<i class="far fa-circle text-primary"></i></a></li>
                        <li><a href="home-section2.php">Section 2<i class="far fa-circle text-success"></i></a></li>
                        <li><a href="testimonial.php">Testimonial <i class="far fa-circle text-info"></i></a></li>
                    </ul>
                </li>
                <li> <a class="waves-effect waves-dark" href="dashboard.php" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Home</span></a></li>
