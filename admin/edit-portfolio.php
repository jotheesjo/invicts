                    ...
                    <div class="card-body">
                        ...
                        echo '<br/><p style="color:#ff0000">'.$_GET['msg'].'</p>';
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="portfolio_id" required value="<?=$app_list['portfolio_id'];?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?=$app_list['link'];?>" id="firstName" class="form-control" placeholder="Youtube Link" name="link" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-success" name="update_portfolio"> <i class="fa fa-check"></i> Save</button>
                            </div>
                        </form>
                    </div>
                </div>
