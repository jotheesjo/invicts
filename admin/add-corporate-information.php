...
include("aside.php");
$department=mysqli_query($conn,"SELECT * FROM corporate_department WHERE department_status='1'");
...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">ADD CORPORATE MEMBERS</h4>
            </div>
        </div>
        <!-- ============================================================== -->
                        ...
                        echo '<br/><p style="color:#ff0000">'.$_GET['msg'].'</p>';
                                    ...
                                    <div class="col-md-4 ">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" placeholder="Department" name="department" required>
                                                ...
                                                <?php while($deprow=mysqli_fetch_array($department)){ ?>
                                                <option value="<?=$deprow['department_id'];?>"><?=$deprow['department_name'];?></option>
                                                <?php }?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Role</label>
                                            <select class="form-control custom-select" name="emp_role" id="role" required>
    ...
    echo '<option '.$sel.' value='.$state_row['id'].'>'.$state_row['name'].'</option>'; } ?>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-success" name="insert_corporate"> <i class="fa fa-check"></i> Save</button>
                            </div>
                        </form>
                    </div>
                </div>
